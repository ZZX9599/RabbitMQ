...
@SpringBootTest
public class TestConsumerConfirm {

    private static final Logger log = LoggerFactory.getLogger(TestConsumerConfirm.class);
    ...
    public void test01() throws InterruptedException, JsonProcessingException {
        ...
        rabbitTemplate.convertAndSend(
                "consumerConfirmExchange","consumerConfirm",message,data);
